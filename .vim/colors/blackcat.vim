...
highlight DiffAdd             guifg=#eeeeec ctermfg=230 guibg=#008b8b ctermbg=30  gui=none cterm=none
highlight DiffChange          guifg=#eeeeec ctermfg=230 guibg=#008b00 ctermbg=28  gui=none cterm=none
highlight DiffDelete          guifg=#eeeeec ctermfg=230 guibg=#000000 ctermbg=0   gui=none cterm=none
...
highlight Folded              guifg=#b0d0e0 ctermfg=117 guibg=#d2d2d2 ctermbg=252 gui=none cterm=none
highlight Function            guifg=#9bcf8d ctermfg=114                           gui=none cterm=none
...
highlight Todo                guifg=#ebc450 ctermfg=221 guibg=#507080 ctermbg=74  gui=none cterm=none
